...
// Fractional render tick interpolation / extrapolation
...
export const LOCAL_LOOKAHEAD_TICKS = 1.0; // render local bike 1 tick ahead of server (extrapolation window)
