...
import { POWERUP_SPAWN_INTERVAL, POWERUP_SPAWN_DELAY, POWERUP_MAX_ACTIVE, TRAIL_DESTROY_RADIUS } from './constants';
import type { NetEvent } from '../network/NetworkManager';
...
export class PowerUpManager {
  ...
  update(
    ...
    broadcastEvent: ((event: NetEvent) => void) | null,
  ...
  private spawn(broadcastEvent: ((event: NetEvent) => void) | null): void {
  ...
  handleNetEvent(event: NetEvent, bikes: Bike[]): void {
    switch (event.type) {
      case 'powerup-spawn':
